    ...
    Route::group(['middleware' => 'admin'], function () {
        Route::name('admin.')->middleware('demo')->group(function () {
            ...
            Route::name('images.')->prefix('images')->group(function () {
                ...
                Route::get('settings', 'GeneratedImageController@settings')->name('settings');
                Route::post('settings', 'GeneratedImageController@settings')->name('settings.create');
                Route::put('settings', 'GeneratedImageController@settings')->name('settings.edit');
                Route::delete('settings', 'GeneratedImageController@settings')->name('settings.delete');

                Route::get('price', 'GeneratedImageController@price')->name('price');
                Route::post('price', 'GeneratedImageController@price')->name('price.save');
            });
...
Route::group(localizeOptions(), function () {
    ...
    Route::group(['namespace' => 'Frontend', 'middleware' => ['subscribed']], function () {
        ...
        Route::group(['namespace' => 'Auth'], function () {
            ...
            Route::post('logout', 'LoginController@logout')->name('logout')->withoutMiddleware(['subscribed']);;
        ...
        Route::name('checkout.')->prefix('user/checkout')->middleware(['verified', '2fa.verify'])->group(function () {
            Route::post('{checkout_id}/coupon/apply', 'User\CheckoutController@applyCoupon')->name('coupon.apply');
            Route::post('{checkout_id}/coupon/remove', 'User\CheckoutController@removeCoupon')->name('coupon.remove');
        });
        ...
        Route::group(['prefix' => 'user', 'namespace' => 'User', 'middleware' => ['auth', 'verified', '2fa.verify']], function () {
            ...
            Route::name('user.')->group(function () {
                ...
                Route::name('affiliate.')->prefix('affiliate')->group(function () {
                    Route::get('/', 'AffiliateController@index')->name('index');
                    Route::get('/withdraw', 'AffiliateController@withdraw')->name('withdraw');
                });
            });
        });
        Route::middleware(['verified', '2fa.verify'])->group(function () {
            ...
            Route::get('pricing', 'GlobalController@pricing')->name('pricing')->withoutMiddleware(['subscribed']);
