                ...
                <div class="card-v p-0">
                    <div class="settings-box">
                        <div class="settings-box-header border-bottom px-4 py-3">
                            <h5 class="mb-0">{{ lang('My Subscription', 'account') }}</h5>
                        </div>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-12 col-lg">
                                            <h4 class="mb-3">{{ $user->subscription->plan->name }}
                                                ({{ formatInterval($user->subscription->plan->interval) }})</h4>
                                            @if (!$user->subscription->isFree())
                                                <p class="text-muted mb-0">{{ lang('Next bill date', 'account') }} :
                                                    <span
                                                        class="{{ $user->subscription->isAboutToExpire() ? 'text-warning' : ($user->subscription->isExpired() ? 'text-danger' : 'text') }}">{{ dateFormat($user->subscription->expiry_at) }}</span>
                                                </p>
                                            @else
                                                <p class="text-muted mb-0">
                                                    {{ str_replace('{period}', $user->subscription->plan->interval ? lang('month', 'account') : lang('year', 'account'), lang('Your subscription will automatically renew every {period}', 'account')) }}
                                                </p>
                                            @endif
                                        </div>
                                        <div class="col-12 col-lg-auto">
                                            <a href="{{ route('pricing') }}" class="btn btn-primary w-100">
                                                <i class="fa-regular fa-circle-up me-1"></i>
                                                <span>{{ lang('Upgrade', 'account') }}</span>
                                            </a>
                                        </div>
                                        @if (!$user->subscription->isFree() && $user->subscription->isAboutToExpire())
                                            <div class="col-12 col-lg-auto">
                                                <form
                                                    ...
                                                    method="POST">
                                                    @csrf
                                                    <button class="btn btn-outline-primary w-100 action-confirm">
                                                        <i class="fa-solid fa-rotate me-1"></i>
                                                        <span>{{ lang('Renew', 'account') }}</span>
                                                    </button>
                                                </form>
                                            </div>
                                        @endif
                            ...
                            @else
                                <div class="py-5 text-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-3" width="150" height="150"
                                        viewBox="0 0 619.86836 562.03084" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <rect x="60.40639" y="139.84921" width="280.48127" height="277.59048"
                                            rx="26.74409" fill="#f2f2f2" />
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#fff" />
                                        <path d="M877.7568,217.21468H311.02633a1,1,0,0,1,0-2H877.7568a1,1,0,0,1,0,2Z"
                                            transform="translate(-290.06582 -168.98458)" fill="#e6e6e6" />
                                        <ellipse cx="49.31535" cy="9.56458" rx="8.45661" ry="8.64507"
                                            fill="#e6e6e6" />
                                        <ellipse cx="78.5291" cy="9.56458" rx="8.45661" ry="8.64507"
                                            fill="#e6e6e6" />
                                        <ellipse cx="107.74285" cy="9.56458" rx="8.45661" ry="8.64507"
                                            fill="#e6e6e6" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#e6e6e6" />
                                        <path d="M638.94274,186.98458h-69a9,9,0,0,1,0-18h69a9,9,0,0,1,0,18Z"
                                            transform="translate(-290.06582 -168.98458)" fill="#e6e6e6" />
                                        <path
                                            d="M525.3338,486.38416H371.34105a3.32086,3.32086,0,1,1,0-6.64172H525.3338a3.32086,3.32086,0,0,1,0,6.64172Z"
                                            transform="translate(-290.06582 -168.98458)" fill="#f2f2f2" />
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#f2f2f2" />
                                        <polygon
                                            points="430.582 548.714 419.933 548.713 414.868 507.64 430.584 507.641 430.582 548.714"
                                            fill="#a0616a" />
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#2f2e41" />
                                        <polygon
                                            points="537.725 548.714 527.077 548.713 522.011 507.64 537.728 507.641 537.725 548.714"
                                            fill="#a0616a" />
                                        <path
                                        ...
                                        <path
                                            d="M683.16043,537.60686a8.7959,8.7959,0,0,0,2.66491-13.12821l21.10689-38.4259-9.19319-8.45131-24.73528,45.82233a8.78357,8.78357,0,0,0,10.15667,14.18309Z"
                                            transform="translate(-290.06582 -168.98458)" fill="#a0616a" />
                                        <path
                                            d="M734.6398,357.91347l-4.91986,88.1348L706.01713,501.435l-15.42727,20.45876,1.75369-9.27062-10.63419-5.32074-.99855-.49563,20.41561-79.228,1.88048-30.78742A38.36336,38.36336,0,0,1,717.10322,369.364l11.80767-9.59191Z"
                                            transform="translate(-290.06582 -168.98458)" fill="#e6e6e6" />
                                        <rect x="213.68198" y="191.96732" width="280.48127" height="170.59048"
                                            rx="26.74409" fill="#fff" />
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#3f3d56" />
                                        <rect x="243.92262" y="316.26256" width="60" height="7"
                                            rx="3.5" fill="{{ $settings->colors->primary_color }}" />
                                        <rect x="419.92262" y="306.76256" width="44" height="26"
                                            rx="3.5" fill="{{ $settings->colors->primary_color }}" />
                                        <circle cx="261.92262" cy="239.76256" r="18"
                                        ...
                                        <path
                                            ...
                                            transform="translate(-290.06582 -168.98458)" fill="#ccc" />
                                        <path
                                    ...
                                    <h4>{{ lang('You are currently not subscribed', 'account') }}</h4>
                                    <p class="mb-3">
                                        {{ lang('To take advantage of exclusive benefits and features.', 'account') }}
                                    </p>
                                    <a href="{{ route('pricing') }}"
                                        class="btn btn-primary">{{ lang('Subscribe Now', 'account') }}</a>
                                </div>
                            @endif
                        </div>
                    </div>
