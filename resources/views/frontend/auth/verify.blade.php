...
@section('content')
    <div class="sign-box sign-box-wide">
        ...
        <div>
            <p class="h3 mb-3">{{ lang('Verify Your Email Address', 'auth') }}</p>
            <p class="mb-3">
                {{ lang('email verification description', 'auth') }}
            </p>
            <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                @csrf
                <button type="submit" class="btn btn-primary btn-lg me-2">{{ lang('Resend', 'auth') }}</button>
            </form>
                ...
                <form action="{{ route('change.email') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit"
                                class="btn btn-primary btn-md w-100 me-2">{{ lang('Save', 'auth') }}</button>
